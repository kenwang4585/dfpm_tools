...
# Email for CM to send the 3a4 and outlier summary
cm_emails={'FOC':['winslow4@foxconn.com',
                    'alex.ws.kwong@foxconn.com',
                  'stephen.wong@foxconn.com',
                    'ka-lok.yeung@foxconn.com',
                    'raymond.kh.cheung@foxconn.com',
                    'terry.tm.lam@foxconn.com',
                    'tim.lee@foxconn.com',
                    'xiao-bo.wu@foxconn.com',
                    'amy.hy.zhou@mail.foxconn.com',
                    'shi-yu.wang@mail.foxconn.com',
                    'carina.t.guo@mail.foxconn.com',
                    'jane.dj.jiang@mail.foxconn.com',
                    'loretta.ty.yeung@mail.foxconn.com',
                    'telos.xh.mu@mail.foxconn.com',
                    'chris.gj.huang@mail.foxconn.com',
                    'cindy.ml.li@mail.foxconn.com',
                    'zola.p.liu@mail.foxconn.com',
                    'yu-fei.li@mail.foxconn.com',
                    'hurry.xl.zhang@mail.foxconn.com',
                    'yue-juan.zhu@mail.foxconn.com',
                    'chao.c.li@mail.foxconn.com',
                    'cong-cong.zhao@mail.foxconn.com',
                    'zhi-qiang.zou@mail.foxconn.com',
                    'thea.xy.xiang@mail.foxconn.com',
                    'betty.yj.wang@mail.foxconn.com',
                    'hunter.bk.liu@mail.foxconn.com',
                    'hong-rui.lai@mail.foxconn.com',
                    'dai-fa.sun@mail.foxconn.com',
                    'qi-yuan.zhang@mail.foxconn.com',
                    'chun-kai.hua@mail.foxconn.com',
                    'dan.d.lou@mail.foxconn.com',
                    'vicky.cy.lu@foxconn.com',
                    'chloe.jh.chen@mail.foxconn.com',
                    'jean.hz.lin@mail.foxconn.com',
                    'yu.bo@mail.foxconn.com',
                    'jim.gy.zhao@mail.foxconn.com',
                    'staff.kwang2@cisco.com',
                    'jialyan@cisco.com',],
           'FDO':['joan.zhang@flex.com',
                  'monica.wang@flex.com',
                  'jackie.huangdm@flex.com',
                  'Apple.Mo@flex.com',
                  'taylor.chendm@flex.com',
                  'mini.hong@flex.com',
                  'staff.kwang2@cisco.com',
                  'jialyan@cisco.com',]
           }

# below are replaced with the subscription db data
# Cisco internal backlog Dashboard recipient
backlog_dashboard_emails_global={'APJC': ['staff.kwang2@cisco.com',
                                          'jamichie@cisco.com',
                                          'josepcha@cisco.com',
                                          'abougarf@cisco.com',
                                          'jialyan@cisco.com',
                                          'boonpng@cisco.com',
                                          'staff.boonpng@cisco.com',
                                          'shk_btspm@cisco.com',
                                          'mdemarti@cisco.com',
                                          'cchummer@cisco.com',
                                          'seyang@cisco.com',
                                          'chealee@cisco.com',
                                          'wibo@cisco.com'],
                                    'EMEA':['mduijnho@cisco.com',
                                           'annkolst@cisco.com',
                                           'jhedin@cisco.com',
                                           'staff.annkolst@cisco.com',
                                            'cstigter@cisco.com',
                                            'cchummer@cisco.com',
                                            'seyang@cisco.com',
                                           'jamichie@cisco.com',],
                                    'Americas':['fafonsec@cisco.com',
                                           'cchummer@cisco.com',
                                           'johnma@cisco.com',
                                           'maxperez@cisco.com',
                                           'maurmura@cisco.com',
...
# WNBU compliance hold order summary recipients
wnbu_compliance_check_emails_global={'APJC':['julzhou@cisco.com',
                                            'taekim@cisco.com',
                                            'carina.t.guo@foxconn.com',
                                            'amy.hy.zhou@foxconn.com'],
                                     'EMEA':[],
                                     'Americas':[],
                                     }

# Config check emails
# Config check result emails
config_check_emails_global={'APJC':['staff.kwang2@cisco.com','boonpng@cisco.com','seyang@cisco.com',],
                            'EMEA':[],
                            'Americas':['frruvalc@cisco.com',
                                        'gsolisgo@cisco.com',
                                        'gponcehe@cisco.com',
                                        'ramon_lira@jabil.com',
                                        'TANIA_DEL@jabil.com',
                                        'ITZEL_CERVANTES@jabil.com',
                                        'Arturo_Mena@Jabil.com',
                                        'Diego_Rodriguez1@Jabil.com',
                                        'ANAID_ROBLES@jabil.com'],
                            }
...
col_3a4_dfpm=['ORGANIZATION_CODE','SO_SS','PO_NUMBER','OPTION_NUMBER','BUSINESS_UNIT', 'main_bu','main_pf','PRODUCT_FAMILY','PRODUCT_ID','TAN',
        'ADDRESSABLE_FLAG','priority_cat','priority_rank','ss_overall_rank','riso_ranking','ORDER_HOLDS',
              ...
              'SHIP_TO_CUSTOMER_NAME','EXPEDITE_STATUS','EXPEDITE_TYPE','MCD','OTM_SHIPPING_ROUTE_CODE','MFG_LINE_ID',
